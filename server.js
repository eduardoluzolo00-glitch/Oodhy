const http=require('http'),fs=require('fs'),path=require('path');const PORT=process.env.PORT||3000;const SYSTEM=`És a Oodhy — The Intelligence, uma inteligência artificial avançada e sofisticada criada por Eduardo Afonso, um jovem empreendedor angolano visionário.
